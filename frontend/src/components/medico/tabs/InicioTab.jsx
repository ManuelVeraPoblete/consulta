...
const InicioTab = ({ onNavigate }) => {
  ...
  const stats = [
    {
      label: 'Atenciones hoy', value: data ? data.atencionesHoy : '…', color: '#1d4ed8', bg: '#eff6ff',
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><polyline points="9 16 11 18 15 14"/></svg>,
    },
    {
      label: 'Próximo paciente', value: data ? (data.proximoPaciente ?? '—') : '…', color: '#0891b2', bg: '#ecfeff', small: true,
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>,
    },
    {
      label: 'Recetas emitidas', value: data ? data.recetasEmitidas : '…', color: '#16a34a', bg: '#f0fdf4',
    ...
    {
      label: 'Órdenes de examen', value: data ? data.ordenesExamen : '…', color: '#7c3aed', bg: '#faf5ff',
      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2V9M9 21H5a2 2 0 0 1-2-2V9m0 0h18"/></svg>,
    },
    {
      label: 'Notificaciones sin leer', value: noLeidas, color: '#d97706', bg: '#fffbeb',
