...
function BrainIcon({ active }) {
  return <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke={active ? 'white' : 'rgba(255,255,255,0.5)'} strokeWidth="2"><path d="M9.59 4.59A2 2 0 1 1 7.41 2.5M9.59 4.59l2 2m0 0A2 2 0 1 1 13.41 6.5m-2 2l2 2m0 0A2 2 0 1 1 19.41 12.5m-2-2l2 2m0 0A2 2 0 1 1 19.41 18.5m-2-2l2 2m0 0A2 2 0 0 1 12 21a2 2 0 0 1-2-2m0 0l-2-2m0 0A2 2 0 1 1 4.59 14.5m2-2l-2-2"/></svg>;
}
